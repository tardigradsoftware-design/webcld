      ...
      <div className="container flex h-[72px] items-center justify-between gap-6">
                ...
                >
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive(item.href) ? 'text-blue-300' : 'text-white/75 hover:text-white',
                    )}
                  >
                    {item.label}
                    <ChevronDown
        ...
        <div className="hidden items-center gap-2 lg:flex">
          {CONTACT.phone ? (
            ...
            >
              <Phone className="h-4 w-4 text-blue-300" aria-hidden />
              {CONTACT.phone}
            </a>
          ) : null}
          <Link
        ...
        <button
          ...
          className="inline-flex h-11 w-11 items-center justify-center rounded-lg border border-white/15 bg-white/5 text-white transition hover:bg-white/10 lg:hidden"
        >
              ...
              {DESKTOP_NAV.filter((item) => item.href !== '/hizmetler/').map((item) => (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive(item.href) ? 'text-blue-300' : 'text-white',
                  )}
                >
                  {item.label}
                </Link>
